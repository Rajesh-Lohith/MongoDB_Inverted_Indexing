...
//							sb.append(eachEntry.get("description"));
	...
	public Map<String, Map<String, String>> createInvertedIndex(StringBuffer sb, String fileName) {
		...
		// Map<String, Map<String, String>> IndexedMap = new HashMap<String, Map<String,
		// String>>();
		String[] individualString = sb.toString().toLowerCase().replaceAll("[-+./&^:\\,]", " ")
				.replaceAll("a,and,evry,for,from,in,is,it,not,on,to,under, the, or, of", "").split(" ");
		Instant start = Instant.now();
	...
	public String stemming(String stemWord) {
